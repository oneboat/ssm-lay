...
<div class="layui-container">
	<div class="layui-col-sm9">
		    <form class="layui-form" action="" method="post">
			  ...
			  <div class="layui-form-item">
			   ...
			   <!-- <div class="layui-form-item">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="updateTime" id="date" lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
			      </div>
			    </div>
			    </div> -->
			  ...
			  <div class="layui-form-item">
			    <div class="layui-input-block">
			      <button class="layui-btn" lay-submit="" lay-filter="submit_editPermission">立即提交</button>
...
layui.use(['form', 'layedit', 'laydate'], function(){
 ...
 /*  form.verify({
  ...
  //监听提交
  form.on('submit(submit_editPermission)', function(data){
	  $.ajax({
          url: "<%=basePath %>permission/editPermission.do",
