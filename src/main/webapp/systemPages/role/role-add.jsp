			  ...
			  <div class="layui-form-item">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="phone" lay-verify="required" placeholder="请输入角色名" autocomplete="off" class="layui-input">
			      </div>
			    </div>
			  </div>
			  <div class="layui-form-item">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="rolecode" lay-verify="required" placeholder="请输入角色代号" autocomplete="off" class="layui-input">
			      </div>
			    </div>
			  </div>
			  <div class="layui-form-item">
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="number" name="phone" lay-verify="required" placeholder="1~99" autocomplete="off" class="layui-input">
			      </div>
			    </div>
			  </div>
			   <!--  <div class="layui-inline">
...
layui.use(['form', 'layedit', 'laydate'], function(){
 ...
 /*  form.verify({
  ...
  form.on('submit(submit_addRole)', function(data){
	  $.ajax({
          url: "<%=basePath %>role/show/addRole.do",
