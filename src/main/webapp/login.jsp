...
<div align="center">
	...
	<div id="div1" align="center">
		<div id="div2">
			<h3>用户登录</h3><br>
			<form action="<%=basePath %>user/show/loginToAdmin.do" method="post">
				...
				&nbsp;&nbsp;&nbsp;<img id="validateCodeImg" src="<%=basePath%>user/validateCode.do" />&nbsp;&nbsp;
		...
		还没有帐号<a href="<%=basePath %>user/regist.do">点击这里进行注册</a>
	</div>
</div>
</body> 
<script>
					...
					$.ajax({
						...
						var datas = JSON.parse(data);
							...
							if(datas.ifsuc=="true"){
								...
								$.messager.confirm("登录验证信息","用户名或密码有误，请重新输入！",function(){
